...
- [ ] Open http://localhost:5173 and test manually (ready for user acceptance)
...
- [ ] Manual testing on different viewports (ready for user acceptance)
...
- [ ] Code committed and pushed to repository (ready for user to commit)
